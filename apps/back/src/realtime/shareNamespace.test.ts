...
// shareNamespace.ts imports currentSeq from ./sessionRooms, which in turn
// imports getIO from ./io — and io.ts eagerly reads process.env via
// ../lib/env at module load (throws without MONGODB_URI). This suite only
